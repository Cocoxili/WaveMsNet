...
parser.add_argument('--network', type=str, default='M9_srf_fixed_logmel',
    ...
    # for epoch in range(1, 2):
        ...
        if epoch % 20 == 0:
            ...
            if test_acc > best_acc:
                ...
                model_name = '../model/' + args.network + '_fold' + str(foldNum) + 'ESC50_p1_v4.pkl'
...
def main():
    ...
    for fold_num in range(5):
        ...
        validPkl = '../data_wave_ESC10_44100/fold' + str(fold_num) + '_test.cPickle'
        start = time.time()
