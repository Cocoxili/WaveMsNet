...
parser.add_argument('--network', type=str, default='M9_srf_v2',
...
def main_on_fold(foldNum, trainPkl, validPkl):
    ...
    if args.network == 'EnvNet':
        ...
        model = M9_mrf_3Conv()
    elif args.network == 'M9_srf_v2':
        model = M9_srf_v2()
    elif args.network == 'M9_mrf_v2':
        model = M9_mrf_v2()
    elif args.network == 'M9_lrf_v2':
        model = M9_lrf_v2()
    elif args.network == 'M9_v2':
        model = M9_v2()
    elif args.network == 'M9_v3':
        model = M9_v3()
    ...
    # for epoch in range(1, 2):
        ...
        if epoch % 40 == 0:
            ...
            if test_acc > best_acc:
                ...
                model_name = '../model/' + args.network + '_fold' + str(foldNum) + '_v3_epoch' + str(epoch) + '.pkl'
